...
// Update a vehicle
function updateVehicle($invMake, $invModel, $invDescription, $invImage, $invPrice, $invStock, $invThumbnails, $invColor, $classificationId, $invId) {
    $db = phpmotorsConnect();
...
// Wrap vehicles by classifications in a list
